# Proyecto de Gestión de Estudiantes, Algoritmos Estructurados 2025

print(" ")
print("Bienvenidos a 'EduGestor', un Programa Dedicado a la Gestión de Estudiantes")
print(" ")
...
def ejecutar_proyecto():
    while True:
        ...
        if opcion == "1":
            ...
            print(" ")
            print("Gracias por visitar EduGestor. ¡Hasta la próxima!")
            print("\n                Desarrolladores \n")
